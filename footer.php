...
<footer>
  <div class="footer1">
    <div class="part"><!--partie partenaire-->
      <p>Nos Partenaires</p>
    ...
    <div class="contacte"><!--partie contacte-->
      ...
      <div class="contact-info">
        ...
        <a href="contact.php"><input class="btn-contact" type="button" value="Contactez-nous"></a>
      </div>
    </div><!--fin partie contacte-->
  </div>
  <div class="footer2"><!--partie copyright-->
    <i class="far fa-copyright">Simplon.tech-2020-Duguet Mathieu</i>
  </div>
</footer>
